  ...
  [3],
  {
        ...
        m = {
          ...
          data: function() {
            return {
              ...
              approvalPerson: "",
              searchedCompanyName: "",
              searchedCompany: { debtCollectionType: "보고형" },
              guaranteeFeePercentage: 0,
              propertyManagermentCompanyFeePercentage: "",
              propertyManagermentCompanySearchType: "회사명",
          ...
          methods: {
            ...
            clearDatas: function() {
              (this.contractorType = "개인"),
                ...
                (this.comfirmPerson = ""),
                (this.approvalPerson = ""),
                (this.searchedCompany = { debtCollectionType: "보고형" }),
            ...
            updateCompanyListDataSource: function(e) {
              var t = this,
                a = [];
              return (
                "회사명" == this.propertyManagermentCompanySearchType
                  ? (a = e.map(function(e) {
                      return e.companyName;
                    }))
                  : "계약번호" == this.propertyManagermentCompanySearchType &&
                    (a = e.map(function(e) {
            ...
            handleUpdate: function(e) {
              ...
              this.db
                ...
                .then(function(e) {
                  t.$store.dispatch(l.T.GET_USER_LIST, {
                    cb: function() {
                      t.clearDatas(),
                        (t.loading = !1),
                        t.alertMsg({ type: "success", msg: "수정 완료" }),
                        t.moveUserListPage();
                    }
                  });
                })
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "수정 실패" }),
            ...
            handleSubmit: function(e) {
              ...
              this.db
                ...
                .then(function(e) {
                  t.$store.dispatch(l.T.GET_USER_LIST, {
                    cb: function() {
                      t.clearDatas(),
                        (t.loading = !1),
                        t.alertMsg({ type: "success", msg: "등록 완료" }),
                        t.moveUserListPage();
                    }
                  });
                })
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "등록 실패" }),
                    console.error("Error adding document: ", e);
                });
            }
          }
          ...
          methods: {
            ...
            confirm: function(e) {
              ...
              this.db
                ...
                .catch(function(e) {
                  console.log(e),
                    t.alertMsg({ type: "error", msg: "블랙 리스트 해제 실패" });
                });
            },
            cancel: function() {
            ...
            a(
              ...
              [
                ...
                a(
                  "a-input-search",
                  {
                    attrs: { placeholder: "키워드 입력", size: "large" },
                ...
                a(
                  ...
                  [
                    a(
                      ...
                      [
                        a("a-select-option", { attrs: { value: "보고형" } }, [
                          e._v("보고형")
                        ]),
                        a(
                          "a-select-option",
    ...
    "318f": function(e, t, a) {
      ...
      var r = function() {
          ...
          return a("a-table", {
            class:
              "보고형" === e.delinquentFilterType ? "filter-1" : "filter-2",
            attrs: {
              columns: e.columns,
    ...
    "351e": function(e, t, a) {
      ...
      var o = r(a("4db1")),
        ...
        s =
          (a("3d9d"),
          [
            { title: "구분", width: 60, key: "index", dataIndex: "index" },
            {
              title: "기록 날짜",
              width: 180,
              ...
              this.db
                ...
                .then(function() {
                  t.$store.dispatch(s.T.DELETE_USER, e),
                    t.alertMsg({ type: "success", msg: "삭제 완료" });
                })
                .catch(function(e) {
                  console.log(e),
                    t.alertMsg({ type: "error", msg: "삭제 실패" });
                });
            },
            cancel: function() {
              this.alertMsg({ type: "error", msg: "취소" });
                              ...
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: "기타" == e.contractorJobType,
                                  expression: "contractorJobType=='기타'"
                                }
                              ],
                              attrs: {
                                label: "기타 이름",
                                    ...
                                    a(
                                      ...
                                      [
                                        a("ImageUpload", {
                                          ref: "roomMateIdCard",
                                          attrs: {
                                            imageData: e.roomMateIdCard,
                                            imageCbFunc: e.roomMateIdCardFunc
                                          }
                                        })
                                      ],
                                      1
                                ...
                                a(
                                  ...
                                  [
                                    ...
                                    a(
                                      ...
                                      [
                                        a("ImageUpload", {
                                          ref: "guarantorIdCardBack",
                                          attrs: {
                                            imageData: e.guarantorIdCardBack,
                                            imageCbFunc:
                                              e.guarantorIdCardBackFunc
                                          }
                                        })
                                      ],
                                      1
          ...
          methods: {
            updatePaymentDate: function() {
              ...
              this.db
                ...
                .then(function(t) {
                  e.$store.dispatch(l.T.GET_DELINQUENT_LIST, {
                    cb: function() {
                      e.clearDatas(),
                        (e.loading = !1),
                        e.alertMsg({ type: "success", msg: "지불 완료" }),
                ...
                .catch(function(t) {
                  (e.loading = !1),
                    e.alertMsg({ type: "error", msg: "지불 실패" }),
            ...
            setBlackList: function(e) {
              ...
              this.db
                ...
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "블랙 리스트 추가 실패" }),
                    console.error("Error adding document: ", e);
                });
            },
            deleteBlackList: function(e) {
              ...
              this.db
                ...
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "블랙 리스트 삭제 실패" }),
                    console.error("Error adding document: ", e);
                });
            },
              ...
              this.db
                ...
                .then(function(e) {
                  (t.searchedUser.collectionList = !0),
                    t.alertMsg({ type: "success", msg: "회심 추심 지정 완료" }),
                    (t.loading = !1);
                })
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "회심 추심 지정 실패" }),
                    console.error("Error adding document: ", e);
                });
            },
              ...
              this.db
                ...
                .then(function(e) {
                  (t.searchedUser.collectionList = !1),
                    t.alertMsg({ type: "success", msg: "회심 추심 삭제 완료" }),
                    (t.loading = !1);
                })
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "회심 추심 삭제 실패" }),
                    console.error("Error adding document: ", e);
                });
            },
            handleRegister: function(e) {
              ...
              this.db
                ...
                .catch(function(e) {
                  (t.loading = !1),
                    t.alertMsg({ type: "error", msg: "연체자 등록 실패" }),
                    console.error("Error adding document: ", e);
                });
            }
          }
            ...
            a(
              ...
              [
                a(
                  ...
                  [
                    a("a-select-option", { attrs: { value: "대리점명" } }, [
                      e._v("대리점명")
                    ]),
                    a("a-select-option", { attrs: { value: "계약번호" } }, [
                      e._v("계약번호")
                    ]),
                    a("a-select-option", { attrs: { value: "대표자명" } }, [
                      e._v("대표자명")
                    ])
                  ],
                  1
